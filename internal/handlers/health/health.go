...
// @Failure 500 {object} map[string]string "failed to create health metrics"
...
// @Failure 400 {object} map[string]string "invalid user_id or missing parameter"
// @Failure 500 {object} map[string]string "failed to get health metrics"
